...
class EmbedColors:
    ...
    # Base colors
    GREEN = discord.Color.from_rgb(31, 94, 46)
    GOLD = discord.Color.from_rgb(230, 184, 74)
    RED = discord.Color.from_rgb(180, 50, 50)

    # Status colors
    SUCCESS = discord.Color.from_rgb(67, 181, 129)
    ERROR = discord.Color.from_rgb(240, 71, 71)
    WARNING = discord.Color.from_rgb(250, 166, 26)
    NEUTRAL = discord.Color.from_rgb(149, 165, 166)
